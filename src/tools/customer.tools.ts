...
export const customerTools = [
...

  {
    ...
    function: {
      ...
      description:
        'Get a single customer by their MongoDB customer ID.',
      ...
      parameters: {
        ...
        properties: {
          ...
          vehicleModel: {
            type: 'string',
            description:
              'Vehicle model, for example Corolla.'
          },
      ...
      parameters: {
        ...
        properties: {
          ...
          vehicleYear: {
            type: 'number',
            description:
              'New vehicle manufacturing year.'
          }
        },
...

  {
    ...
    function: {
      ...
      description:
        'Delete a customer from the CRM by MongoDB customer ID.',
      ...
      parameters: {
        ...
        properties: {
          customerId: {
            type: 'string',
            description:
              'MongoDB ID of the customer to delete.'
          }
        },
